...
var myPalette = new _palette2.default({ colors: ['rgba(117, 79, 68, 1)', 'rgba(236, 115, 87, 1)', 'rgba(225, 206, 122, 1)', 'rgba(253, 214, 146, 1)', 'rgba(251, 255, 185, 1)'] });

var paletteButton = document.querySelector('.color-palette__btn');
...
var Palette = function () {
  ...
  _createClass(Palette, [{
    ...
    value: function colorClickHandler(event) {
    ...
    value: function bindEvents() {
      ...
      clipboard.on('success', function (event) {
        return _this2.colorClickHandler(event);
      });

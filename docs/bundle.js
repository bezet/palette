...
var myPalette = new _palette2.default({ colors: ['#326273', '#E39774', 'rgba(92, 158, 173, 1)', 'rgba(238, 238, 238, 1)', 'rgba(255, 255, 255, 1)'] });
...
var Palette = function () {
  ...
  _createClass(Palette, [{
    key: 'paletteButtonHandler',
    value: function paletteButtonHandler(event) {
    ...
    value: function bindEvents() {
      ...
      var clipboard = new _clipboard2.default(this.settings.paletteClass + '__color');

      // clipboard.on('success', () => this.animateColor());
      this.paletteButton.addEventListener('click', function (event) {
        return _this2.paletteButtonHandler(event);
      });
    }
  }, {
    key: 'createPalette',
    value: function createPalette() {
      ...
      this.settings.colors.forEach(function (color, index) {
        var colorButton = document.createElement('button');
        colorButton.classList.add(_this3.settings.paletteClass + '__color');

        // const colorValue = rgbToHex(color).replace(/"/g, '').toLowerCase();
        var colorValue = color.replace(/"/g, '').toLowerCase();

        colorButton.dataset.clipboardText = colorValue;
        colorButton.style.background = colorValue;

        _this3.palette.appendChild(colorButton);
      });
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(3), __webpack_require__(5), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(4)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
